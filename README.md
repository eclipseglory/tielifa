...
### Canvas2D API
TieLiFa implemented canvas 2d some frequently used methods ,such as ```drawImage``` , ```fillRect``` and so on , you can check what's TieLiFa has implemented from this tabel.
### Extended API
